...
public class MyBinarySearchTree {
    ...
    public void Seach(TreeNode root,int value) {
        if(root == null){
            return;
        }
        while(true){
            if(root.value == value){
                System.out.print("Đây là kết quả :"+ root.value + "\t");
                break;
            }
            else{
                if(value < root.value){
                    root = root.left;
                    System.out.print("Đi theo Node bên trái : " + root.value + "\t");
                }
                else{
                    root = root.right;
                    System.out.print("Đi theo Node bên phải : " + root.value + "\t");
                }
            }
        }
